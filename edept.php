                ...
                <div class="mb-lg-8">
                    <div class="col-lg-9 mx-auto">
                        <div class="bg-white mt-n10 mt-md-n13 pt-5 pt-lg-7 px-3 px-md-5 pl-xl-10 pr-xl-4">
                            ...
                            <a href="ViewDepartment.php" class="btn btn-danger float-right">View Department</a>
                                <h6 class="font-weight medium font-size-10 mb-4 mb-lg-7 text-center">Update Department</h6>
                   ...
                   if (isset($_GET['deptid'])) {
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        $sql = "UPDATE `department` SET  `deptname` =  '{$_POST['deptname']}'  WHERE `deptid` = '$deptid' ";
                        mysqli_query($con,$sql) or die(mysqli_error($con));
                        
                        if(mysqli_affected_rows($con))
                        {
                            Print '<script>alert("Department Updated Successfully");</script>'; 
                                    ...
                                    <form action="" method="post">
                                        <div class="form-group mb-4">
                                            <div class="js-form-message js-focus-state">
                                                ...
                                                <input type="text" class="form-control rounded-0 height-4 px-4" name="deptname" id="deptname" value="<?php echo stripslashes($row['deptname']) ?>" placeholder="Enter Department Name" required="">
                                            </div>
                                        </div>
                                        <div class="mb-3">
