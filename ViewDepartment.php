                ...
                <div class="mb-lg-8">
                    <div class="col-lg-9 mx-auto">
                        <div class="bg-white mt-n10 mt-md-n13 pt-5 pt-lg-7 px-3 px-md-5 pl-xl-10 pr-xl-4">
                            ...
                            <a href="AddDepartment.php" class="btn btn-danger float-right">Add Department</a>
                                <h6 class="font-weight medium font-size-10 mb-4 mb-lg-7 text-center">View Department</h6>
...
echo "<td>
    <a class='btn btn-sm btn-info' href=edept.php?deptid={$row['deptid']}><i class='fas fa-edit'></i></a>
    <a class='btn btn-sm btn-danger' href=ddept.php?deptid={$row['deptid']}><i class='fas fa-trash'></i></a>
    </td> ";
