                    ...
                    <div class="col-lg-9 mx-auto">
                        <div class="bg-white mt-n10 mt-md-n13 pt-5 pt-lg-7 px-3 px-md-5 pl-xl-10 pr-xl-4">
                            <div class="mb-4 mb-lg-7 ml-xl-4">
                                <h6 class="font-weight medium font-size-10 mb-4 mb-lg-7">Student Login</h6>
                            </div>
                            ...
                            <div id="signup" style="opacity: 1;" data-target-group="idForm" class="animated fadeIn">
                                ...
                                <form action="chkusrlgn.php" method="post">
                                    <div class="form-group mb-4">
                                        <div class="js-form-message js-focus-state">
                                            <label id="signinEmailLabel1" class="form-label" for="admname">Student USN</label>
                                            <input type="text" class="form-control rounded-0 height-4 px-4" name="admname" id="admname" placeholder="Enter Student USN" required="">
                                        </div>
                                    </div>
